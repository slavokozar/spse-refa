...
@section('content')
    ...
    <div class="container">
        ...
        <ul class="nav nav-tabs">
            ...
            <li role="presentation" class="active"><a href="{{ action('Stats\UserStatsController@solved', [$user->id]) }}">Vyriesene</a></li>
        </ul>

        <div class="alert alert-info" role="alert">Vsetky poziadavky, vyriesene uzivatelom {{ ucfirst($user->name) }}</div>
