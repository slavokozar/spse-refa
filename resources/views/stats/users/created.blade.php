...
@section('content')
    ...
    <div class="container">
        ...
        <ul class="nav nav-tabs">
            ...
            <li role="presentation" class="active"><a href="{{ action('Stats\UserStatsController@created', [$user->id]) }}">Vytvorene</a></li>
        ...
        <div class="alert alert-info" role="alert">Vsetky poziadavky, vytvorene uzivatelom {{ ucfirst($user->name) }}</div>
            ...
            @if(sizeof($tickets) > 0)
                <table class="table table-striped table-bordered">
                    ...
                    @foreach($tickets as $ticket)
                        <tr>
                            <th>
                                <a href="{{ action('Tickets\TicketController@show', [$ticket->id]) }}" data-toggle="modal">
                                    {{ $ticket->pc }}
                                </a>
                            </th>
                            <td>
