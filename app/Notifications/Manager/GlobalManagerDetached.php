...
class GlobalManagerDetached extends Notification
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
                    ->subject('Odobraná rola globálneho správcu ' . $this->level . '. úrovne' )
                    ->greeting('Zdravím ' . $notifiable->name)
                    ->line('Bola Vám odobraná rola globálneho správcu ' . $this->level . '. úrovne')
